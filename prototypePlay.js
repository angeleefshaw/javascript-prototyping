function User(email, firstName, lastName, online) {
    this.email = email;
...
var arrayOfNumbers = [1,4,7,7,6,4,5,12,88,67,67,5,5,90,101,122,222,565,55,66,23,23,24,25,22,3,4,1,90,88,12,12];

removeDuplicates(arrayOfNumbers);
